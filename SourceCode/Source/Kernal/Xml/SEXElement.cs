...
namespace  Sheng.SailingEase.Kernal
{
    ...
    /// 这一点不同于 XmlDocument
    /// </summary>
    public class SEXElement : XElement
    {
        #region 构造
        ...
        public SEXElement(XElement other)
            : base(other)
        {
        }
        ...
        /// </summary>
        /// <param name="other"></param>
        public SEXElement(XStreamingElement other)
            : base(other)
        {
        }
        ...
        public SEXElement(XName name, object content)
            : base(name, content)
        {
        }
        ...
        /// <param name="name"></param>
        /// <param name="content"></param>
        public SEXElement(XName name, params object[] content)
            : base(name, content)
        {
        }
        ...
        public static new SEXElement Parse(string xml)
        {
            return new SEXElement(XElement.Parse(xml));
        }
