...
namespace Sheng.SIMBE.SEControl.Docking
{
    ...
    [ToolboxBitmap(typeof(resfinder), "Sheng.SIMBE.SEControl.Docking.DockPanel.bmp")]
	...
	public partial class DockPanel : Panel
	{
        ...
        private TabAlign m_tabAlign = TabAlign.Top;
        [LocalizedCategory("Category_Docking")]
        [LocalizedDescription("选项卡所处的位置")]
        [DefaultValue(TabAlign.Top)]
        public TabAlign TabAlign
        {
            get { return m_tabAlign; }
            set { m_tabAlign = value; }
        }
