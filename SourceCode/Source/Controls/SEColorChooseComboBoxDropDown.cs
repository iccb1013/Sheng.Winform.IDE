...
{
    [ToolboxItem(false)]
    [LicenseProvider(typeof(SEColorChooseComboBoxDropDown))]
    internal partial class SEColorChooseComboBoxDropDown : UserControl
    {
        ...
        private SEColorChooseComboBox colorChooseComboBox;
        /// <summary>
        /// 所在的ComboBox
        /// </summary>
        public SEColorChooseComboBox ColorChooseComboBox
        {
            get
            {
        ...
        public SEColorChooseComboBoxDropDown()
        {
            //死循环
