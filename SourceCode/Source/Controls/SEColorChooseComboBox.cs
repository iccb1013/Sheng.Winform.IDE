...
namespace Sheng.SailingEase.Controls
{
    ...
    public partial class SEColorChooseComboBox : UserControl
    {
        ...
        /// 颜色选取框
        /// </summary>
        private SEColorChooseComboBoxDropDown dropUserControl = new SEColorChooseComboBoxDropDown();

        public SEColorChooseComboBox()
        {
            LicenseManager.Validate(typeof(SEColorChooseComboBox)); 
