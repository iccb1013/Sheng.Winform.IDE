...
namespace Sheng.SailingEase.Controls
{
    ...
    public class SEToolStripMenuItem : ToolStripMenuItem
    {

        StringFormat stringFormat = new StringFormat();

        public SEToolStripMenuItem()
            : this(String.Empty)
        {
            LicenseManager.Validate(typeof(SEToolStripMenuItem)); 
        }

        public SEToolStripMenuItem(string strName)
            : base(strName)
        {
            LicenseManager.Validate(typeof(SEToolStripMenuItem)); 
