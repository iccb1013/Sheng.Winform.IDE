...
namespace Sheng.SailingEase.Controls.SEAdressBar
{
    ...
    [ToolboxItem(false)]
    public class SEAddressBarStrip : ToolStrip
    {
        #region 公开事件
        ...
        /// </summary>
        private IAddressNode _rootNode = null;

        /// <summary>
        /// Node contains the currently selected node (e.g. previous node)
        /// </summary>
        private IAddressNode _currentNode = null;
        ...
        /// </summary>
        SEAddressBarDropDownButton _overflowButton = new SEAddressBarDropDownButton("<<")
        {
            ShowDropDownArrow = false
        };

        SEAddressBarDropDown _overflowDropDown = new SEAddressBarDropDown();

        /// <summary>
        /// 当前显示在地址栏中的Button集合
        /// </summary>
        List<SEAddressBarButton> _buttonList = new List<SEAddressBarButton>();
        ...
        public void SetAddress(string path)
        {
            ...
            for (int i = 0; i < pathArray.Length; i++)
            {
                ...
                foreach (IAddressNode node in _currentNode.Children)
                {
        ...
        {
            foreach (SEAddressBarButton button in _buttonList)
            {
        ...
        private void OverflowDestroyed(Object sender, EventArgs e)
        {
            ...
            if (sender.GetType() == typeof(SEAddressBarDropDownButton))
            {
                //get the button as the right type
                SEAddressBarDropDownButton tsddb = (SEAddressBarDropDownButton)sender;
