...
namespace Sheng.SailingEase.Controls.SEPad
{
    [Designer(typeof(SEPadDesigner))]
    public class SEPad : ContainerControl
    {
        ...
        internal class SEPadDesigner : ControlDesigner
        {
            private SEPad _pad;
