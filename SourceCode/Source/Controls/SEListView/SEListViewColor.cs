...
namespace Sheng.SailingEase.Controls
{
    ...
    public class SEListViewColor
    {
        ...
        /// </summary>
        public static SEListViewColor Default { get { return SEListViewColor.GetDefaultTheme(); } }
        /// <summary>
        /// Represents the noir color theme.
        /// </summary>
        public static SEListViewColor Noir { get { return SEListViewColor.GetNoirTheme(); } }
        /// <summary>
        /// Represents the mandarin color theme.
        /// </summary>
        public static SEListViewColor Mandarin { get { return SEListViewColor.GetMandarinTheme(); } }

        /// <summary>
        /// Sets the color palette to default colors.
        /// </summary>
        private static SEListViewColor GetDefaultTheme()
        {
            return new SEListViewColor();
        }
        /// <summary>
