...
namespace Sheng.SailingEase.Controls
{
    public class SEListView : Control
    {
        ...
        internal void OnItemDoubleClick(SEListViewItem item)
        {
        ...
        internal string GetItemText(object itemValue)
        {
            ...
            {
                SEListViewGetItemTextEventArgs args = new SEListViewGetItemTextEventArgs(itemValue);
        ...
        /// </summary>
        /// <returns></returns>
        internal List<SEListViewItem> GetSelectedItems()
        {
        ...
        public void AddExtendMember(ISEListViewExtendMember member)
        {
        ...
        {
            List<SEListViewItem> selectedItems = GetSelectedItems();
        ...
        public void DataBind(IList list)
        {
            ...
            {
                this.Items.Add(new SEListViewItem(item));
            }
            ResumeLayout();
        }
        ...
        /// 通过外能事件获取用于绘制项的文本
        /// </summary>
        public event EventHandler<SEListViewGetItemTextEventArgs> ItemTextGetting;
