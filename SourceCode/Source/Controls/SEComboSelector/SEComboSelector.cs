...
{
    public partial class SEComboSelector : UserControl, ISEValidate
    {
        #region 私有成员
        ...
        private SEComboSelectorItemContainer _itemContainer;
        ...
        public SEComboSelector()
        {
            ...
            _itemContainer = new SEComboSelectorItemContainer();
            _popup = new Popup(_itemContainer);
            //_popup.Resizable = true;

            _popup.Closed += new ToolStripDropDownClosedEventHandler(_popup_Closed);
            _itemContainer.OnSelectedItemChangedClick += new SEComboSelectorItemContainer.OnSelectedItemChangedHandler(_itemContainer_OnSelectedItemChanged);
            _itemContainer.OnItemClick += new SEComboSelectorItemContainer.OnItemClickHandler(_itemContainer_OnItemClick);
        ...
        void _itemContainer_OnSelectedItemChanged(SEComboSelectorItem item)
        {
            this.Invalidate();
        ...
        void _itemContainer_OnItemClick(SEComboSelectorItem item)
        {
            _popup.Close();
        }
