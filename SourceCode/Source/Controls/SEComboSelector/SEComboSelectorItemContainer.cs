...
{
    public partial class SEComboSelectorItemContainer : UserControl
    {
        #region 私有成员
        ...
        private SEComboSelectorItemCollection _items = new SEComboSelectorItemCollection();
        public SEComboSelectorItemCollection Items
        {
            get { return _items; }
        }
        ...
        /// 当前选定的项目
        /// </summary>
        public SEComboSelectorItem SelectedItem
        {
            get
            {
        ...
        private SEComboSelectorItem _hotedItem;
        /// <summary>
        /// 当前热点项目
        /// </summary>
        public SEComboSelectorItem HotedItem
        {
            ...
            private set
            {
                if (value != _hotedItem)
                {
                    SEComboSelectorItem _oldHot = _hotedItem as SEComboSelectorItem;
        ...
        public SEComboSelectorItemContainer()
        {
            InitializeComponent();
        ...
        private void CreateItem()
        {
            ...
            if (this.DataSource != null)
            {
                ...
                {
                    AddItem(new SEComboSelectorItem(value));
                }
            }
        }

        private void AddItem(SEComboSelectorItem item)
        {
        ...
        public delegate void OnSelectedItemChangedHandler(SEComboSelectorItem item);
        /// <summary>
        /// 单击（选择）项时发生
        /// </summary>
        public event OnSelectedItemChangedHandler OnSelectedItemChangedClick;

        public delegate void OnHotedItemChangedHandler(SEComboSelectorItem item);
        /// <summary>
        /// 当前热点项生改变
        /// </summary>
        public event OnHotedItemChangedHandler OnHotedItemChanged;

        public delegate void OnItemClickHandler(SEComboSelectorItem item);
        /// <summary>
        /// 单击项
        /// </summary>
