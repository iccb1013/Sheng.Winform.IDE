...
{
    partial class SEMessageBoxCmdLink : SEMessageBoxBase, ISEMessageBoxForm
    {
        #region Constants
        ...
        private Size GetButtonSize()
        {
            ...
            Size buttonSize = new Size(300, 50);
        ...
        private void SetOptimumSize()
        {
            ...
            int buttonsRowHeight = GetHeightOfAllButtons();
            int captionWidth = GetCaptionSize().Width;

            int maxItemWidth = Math.Max(saveResponseRowWidth, Math.Max(iconAndMessageRowWidth, GetButtonSize().Width));
            ...
            int requiredHeight = TOP_PADDING + Math.Max(rtbMessage.Height, panelIcon.Height) + ITEM_PADDING + chbSaveResponse.Height + ITEM_PADDING + GetHeightOfAllButtons() + BOTTOM_PADDING + ncHeight;
        ...
        /// </summary>
        private int GetHeightOfAllButtons()
        {
            Size buttonSize = GetButtonSize();
            int allButtonsWidth = buttonSize.Height * _buttons.Count + BUTTON_PADDING * (_buttons.Count - 1);
