...
namespace Sheng.SailingEase.Controls
{
     ...
     */
    public class SEComboSelector2 : Control, ISEValidate
    {
        #region 私有成员
        ...
        private SEListView _listView;

        #region 当前状态

        private SEComboSelectorState _state = SEComboSelectorState.None;

        private bool Selected
        {
            get
            {
                return (_state & SEComboSelectorState.Selected) == SEComboSelectorState.Selected;
            }
            set
            {
                ...
                if (value)
                    _state = _state | SEComboSelectorState.Selected;
                else
                    _state = _state ^ SEComboSelectorState.Selected;
        ...
        private bool Hovered
        {
            get
            {
                return (_state & SEComboSelectorState.Hovered) == SEComboSelectorState.Hovered;
            }
            set
            {
                ...
                if (value)
                    _state = _state | SEComboSelectorState.Hovered;
                else
                    _state = _state ^ SEComboSelectorState.Hovered;
        ...
        private SEComboSelectorTheme _theme = new SEComboSelectorTheme();
        public SEComboSelectorTheme Theme
        {
            get { return _theme; }
            set { _theme = value; }
        }
        ...
        public string DescriptionMember
        {
            ...
            set
            {
                ...
                _listView.SetExtendMember(SEListViewDescriptiveMembers.DescriptioinMember, value);
            }
        }
        ...
        public SEComboSelector2()
        {
            ...
            _listView.LayoutMode = ListViewLayoutMode.Descriptive;
            ...
            _listView.ItemTextGetting += new EventHandler<SEListViewGetItemTextEventArgs>(_listView_ItemTextGetting);
        ...
        void _listView_ItemTextGetting(object sender, SEListViewGetItemTextEventArgs e)
        {
