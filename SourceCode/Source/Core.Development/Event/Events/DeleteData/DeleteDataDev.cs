...
{
    [Serializable]
    class DeleteDataDev : DeleteDataEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new DeleteDataDevEditorAdapter(this);
        ...
        {
            DeleteDataDevChecker.CheckWarning(this);
        }
    }
}
