...
{
    [Serializable]
    class ClearFormDataDev : ClearFormDataEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new ClearFormDataDevEditorAdapter(this);
        ...
        {
            ClearFormDataDevChecker.CheckWarning(this);
        }
    }
}
