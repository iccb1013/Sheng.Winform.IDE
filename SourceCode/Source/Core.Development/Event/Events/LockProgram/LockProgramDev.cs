...
{
    [Serializable]
    class LockProgramDev : LockProgramEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new LockProgramDevEditorAdapter(this);
        ...
        {
            LockProgramDevChecker.CheckWarning(this);
        }
    }
}
