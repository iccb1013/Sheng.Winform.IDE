...
{
    [Serializable]
    class CallAddInDev : CallAddInEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new CallAddInDevEditorAdapter(this);
        ...
        {
            CallAddInDevChecker.CheckWarning(this);
        }
    }
}
