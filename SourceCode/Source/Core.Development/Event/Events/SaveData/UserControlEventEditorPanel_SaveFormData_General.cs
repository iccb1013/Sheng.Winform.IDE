...
{
    [ToolboxItem(false)]
     partial class UserControlEventEditorPanel_SaveFormData_General : UserControlEventEditorPanelBase
    {
        public UserControlEventEditorPanel_SaveFormData_General(EventEditorAdapterAbstract hostAdapter)
            : base(hostAdapter)
        {
            InitializeComponent();
        ...
        {
            this.txtName.Title = Language.Current.UserControlEventEditorPanel_SaveFormData_General_LabelName;
            this.txtCode.Title = Language.Current.UserControlEventEditorPanel_SaveFormData_General_LabelCode;
        ...
        public override string PanelTitle
        {
            get
            {
                return Language.Current.SaveFormDataDev_EditorPanel_General;
            }
        }
