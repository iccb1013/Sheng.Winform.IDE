...
{
    [Serializable]
    class CloseFormDev : CloseFormEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new CloseFormDevEditorAdapter(this);
        ...
        {
            CloseFormDevChecker.CheckWarning(this);
        }
    }
}
