...
{
    [ToolboxItem(false)]
    partial class UserControlEventEditorPanel_CloseForm_General : UserControlEventEditorPanelBase
    {
        public UserControlEventEditorPanel_CloseForm_General(EventEditorAdapterAbstract hostAdapter)
            : base(hostAdapter)
        {
            InitializeComponent();
        ...
        {
            this.txtName.Title = Language.Current.UserControlEventEditorPanel_CloseForm_General_LabelName;
            this.txtCode.Title = Language.Current.UserControlEventEditorPanel_CloseForm_General_LabelCode;
        ...
        {
            CloseFormDev _event = even as CloseFormDev;
