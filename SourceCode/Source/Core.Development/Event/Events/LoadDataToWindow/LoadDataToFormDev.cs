...
{
    [Serializable]
    class LoadDataToFormDev : LoadDataToFormEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new LoadDataToFormDevEditorAdapter(this);
        ...
        public static EnumEventDataSource AllowLoadDataDataSourceType
        {
            get
            {
        ...
        {
            LoadDataToFormDevChecker.CheckWarning(this);
        }
    }
}
