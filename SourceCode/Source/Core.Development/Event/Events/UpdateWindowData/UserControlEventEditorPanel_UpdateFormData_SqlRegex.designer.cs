...
{
    partial class UserControlEventEditorPanel_UpdateFormData_SqlRegex
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblNotice.Text = "${UserControlEventEditorPanel_UpdateFormData_SqlRegex_LabelNotice}";
            ...
            this.btnGetSqlRegex.Text = "${UserControlEventEditorPanel_UpdateFormData_SqlRegex_ButtonGetSqlRegex}";
            ...
            this.Name = "UserControlEventEditorPanel_UpdateFormData_SqlRegex";
