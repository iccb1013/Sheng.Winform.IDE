...
{
    [ToolboxItem(false)]
     partial class UserControlEventEditorPanel_UpdateFormData_General : UserControlEventEditorPanelBase
    {
        public UserControlEventEditorPanel_UpdateFormData_General(EventEditorAdapterAbstract hostAdapter)
            : base(hostAdapter)
        {
            InitializeComponent();
        ...
        {
            this.txtName.Title = Language.Current.UserControlEventEditorPanel_UpdateFormData_General_LabelName;
            this.txtCode.Title = Language.Current.UserControlEventEditorPanel_UpdateFormData_General_LabelCode;
        ...
        public override string PanelTitle
        {
            get
            {
                return Language.Current.UpdateFormDataDev_EditorPanel_General;
            }
        }
        ...
        public override List<XObject> GetXml()
        {
            ...
            {
                _xObject.Add(new XElement("Mode", (int)UpdateFormDataEvent.EnumUpdateFormDataMode.DataEntity));
            }
            else
            {
                _xObject.Add(new XElement("Mode", (int)UpdateFormDataEvent.EnumUpdateFormDataMode.SQL));
            }
            return _xObject;
        }
        public override void SetParameter(EventBase even)
        {
            ...
            if (_event.UpdateMode == UpdateFormDataEvent.EnumUpdateFormDataMode.DataEntity)
            {
