...
{
    [Serializable]
    class UpdateFormDataDev : UpdateFormDataEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new UpdateFormDataDevEditorAdapter(this);
        ...
        {
            UpdateFormDataDevChecker.CheckWarning(this);
        }
    }
}
