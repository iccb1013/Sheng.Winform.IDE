...
{
    [Serializable]
    class OpenSystemFormDev : OpenSystemFormEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new OpenSystemFormDevEditorAdapter(this);
        ...
        {
            OpenSystemFormDevChecker.CheckWarning(this);
        }
    }
}
