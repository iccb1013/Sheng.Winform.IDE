...
{
    [Serializable]
    class StartProcessDev : StartProcessEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new StartProcessDevEditorAdapter(this);
        ...
        {
            StartProcessDevChecker.CheckWarning(this);
        }
    }
}
