...
{
    [ToolboxItem(false)]
    partial class UserControlEventEditorPanel_ReturnDataToCallerForm_General : UserControlEventEditorPanelBase
    {
        public UserControlEventEditorPanel_ReturnDataToCallerForm_General(EventEditorAdapterAbstract hostAdapter)
            : base(hostAdapter)
        {
            InitializeComponent();
        ...
        {
            this.txtName.Title = Language.Current.UserControlEventEditorPanel_ReturnDataToCallerForm_General_LabelName;
            this.txtCode.Title = Language.Current.UserControlEventEditorPanel_ReturnDataToCallerForm_General_LabelCode;
        ...
        public override string PanelTitle
        {
            get
            {
                return Language.Current.ReturnDataToCallerFormDev_EditorPanel_General;
            }
        }
