...
{
    [Serializable]
    class ReturnDataToCallerFormDev : ReturnDataToCallerFormEvent, IEventEditorSupport, IWarningable
    {
        [NonSerialized]
        ...
        public EventEditorAdapterAbstract EditorAdapter
        {
            get
            {
                if (_editorAdapater == null)
                    _editorAdapater = new ReturnDataToCallerFormDevEditorAdapter(this);
        ...
        {
            ReturnDataToCallerFormDevChecker.CheckWarning(this);
        }
    }
}
