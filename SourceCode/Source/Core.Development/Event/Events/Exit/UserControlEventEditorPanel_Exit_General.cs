...
{
    [ToolboxItem(false)]
    partial class UserControlEventEditorPanel_Exit_General : UserControlEventEditorPanelBase
    {
        public UserControlEventEditorPanel_Exit_General(EventEditorAdapterAbstract hostAdapter)
            : base(hostAdapter)
        {
            InitializeComponent();
        ...
        {
            this.txtName.Title = Language.Current.UserControlEventEditorPanel_Exit_General_LabelName;
            this.txtCode.Title = Language.Current.UserControlEventEditorPanel_Exit_General_LabelCode;
        ...
        public override string PanelTitle
        {
            get
            {
                return Language.Current.ExitDev_EditorPanel_General;
            }
        }
        ...
        {
            ExitDev _event = even as ExitDev;
