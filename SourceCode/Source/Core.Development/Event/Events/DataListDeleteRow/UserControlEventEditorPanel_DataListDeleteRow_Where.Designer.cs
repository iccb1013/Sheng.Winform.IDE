...
{
    partial class UserControlEventEditorPanel_DataListDeleteRow_Where
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ColumnDataColumnName.HeaderText = "${UserControlEventEditorPanel_DataListDeleteRow_Where_ColumnDataColumnName}";
            ...
            this.ColumnSourceName.HeaderText = "${UserControlEventEditorPanel_DataListDeleteRow_Where_ColumnSourceName}";
            ...
            this.Name = "UserControlEventEditorPanel_DataListDeleteRow_Where";
