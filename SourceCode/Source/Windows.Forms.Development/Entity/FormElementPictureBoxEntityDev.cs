...
{
    [Serializable]
    class FormElementPictureBoxEntityDev : UIElementPictureBoxEntity, IFormElementEntityDev, IWarningable
    {
        public FormElementPictureBoxEntityDev()
            : base()
        {
            this.Width = 50;
            this.Height = 50;
        ...
        {
            get { return typeof(SEPictureBoxExDev); }
        }
        ...
        {
            FormElementPictureBoxEntityDevChecker.CheckWarning(this);
        }
    }
}
