...
{
    class ImageListViewLayoutManager
    {
        #region 常量
        ...
        private ImageListViewRenderer _renderer;
        ...
        public ImageListViewLayoutManager(ImageListView imageListView)
        {
            ...
            _renderer = new ImageListViewStandardRenderer(this);
            //_renderer = new ImageListViewRenderer(this);
        ...
        internal void OnItemsRemoved(List<ImageListViewItem> items)
        {
        ...
        public void RenderItem(Graphics graphics, ImageListViewItem item)
        {
        ...
        /// <returns></returns>
        public ImageListViewItemVisibility IsItemVisible(ImageListViewItem item)
        {
            int itemIndex = _imageListView.Items.IndexOf(item);

            if (_imageListView.Items.Count == 0)
                return ImageListViewItemVisibility.NotVisible;
            ...
            if (itemIndex < _firstPartiallyVisible || itemIndex > _lastPartiallyVisible)
                ...
                return ImageListViewItemVisibility.Visible;
            else
                return ImageListViewItemVisibility.PartiallyVisible;
        }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public Rectangle GetItemBounds(ImageListViewItem item)
        {
        ...
        public List<ImageListViewItem> GetItems()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ImageListViewItem> GetVisibleItems()
        {
        ...
        public ImageListViewHitInfo HitTest(Point point)
        {
            int itemIndex = -1;
            ...
            if (_imageListView.Items.Count != 0)
            {
                ...
                if (index != newindex)
                {
                    ...
                    else if (_imageListView.AllowMultiSelection && ShiftKey)
                    {
                        int startIndex = 0;
                        int endIndex = 0;
                        List<ImageListViewItem> selectedItems = _imageListView.GetSelectedItems();
