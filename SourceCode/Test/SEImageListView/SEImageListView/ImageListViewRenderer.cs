...
namespace SEImageListView
{
    ...
    class ImageListViewRenderer
    {
        ...
        internal ImageListViewTheme Theme { get; set; }

        protected ImageListViewLayoutManager _layoutManager;
        internal ImageListViewLayoutManager LayoutManager { get { return _layoutManager; } }

        #region 构造

        public ImageListViewRenderer(ImageListViewLayoutManager layoutManager)
        {
        ...
        public void RenderItem(Graphics g, ImageListViewItem item)
        {
            if (LayoutManager.Suspend)
                return;

            if (LayoutManager.IsItemVisible(item) == ImageListViewItemVisibility.NotVisible)
                return;
        ...
        internal virtual void OnItemsRemoved(List<ImageListViewItem> items)
        {
        ...
        {
            // Paint background
            using (Brush bItemBack = new SolidBrush(Color.LightGray))
            {
        ...
        /// <param name="bounds"></param>
        /// <param name="item"></param>
        internal virtual void DrawItemContent(Graphics g, Rectangle bounds, ImageListViewItem item)
        {
            //显示debug信息
        ...
        private void RenderItems(Graphics g)
        {
            ...
            List<ImageListViewItem> items = LayoutManager.GetVisibleItems();
