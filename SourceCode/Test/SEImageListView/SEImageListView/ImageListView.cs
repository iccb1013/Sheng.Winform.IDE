...
namespace SEImageListView
{
    class ImageListView : Control
    {
        ...
        private ImageListViewLayoutManager _layoutManager;
        ...
        private ImageListViewItem _hoveredItem;
        /// <summary>
        /// 当前鼠标经过的项
        /// </summary>
        internal ImageListViewItem HoveredItem
        {
            get { return _hoveredItem; }
            private set
            {
                ImageListViewItem oldHoveredItem = _hoveredItem;
                ImageListViewItem newHoveredItem = value;
        ...
        private ImageListViewTheme _theme = new ImageListViewTheme();
        /// <summary>
        /// 配色方案
        /// </summary>
        public ImageListViewTheme Theme
        {
            get
            {
                return _theme;
        ...
        private ImageListViewCollection _items = new ImageListViewCollection();
        public ImageListViewCollection Items
        {
            get { return _items; }
            set { _items = value; }
        }
        ...
        public ImageListViewLayoutManager LayoutManager
        {
        ...
        public ImageListView()
        {
            ...
            _layoutManager = new ImageListViewLayoutManager(this);
        ...
        internal void RenderItem(ImageListViewItem item)
        {
            if (Suspend == false)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<ImageListViewItem> GetSelectedItems()
        {
        ...
        public void OnItemDoubleClick(ImageListViewItem item)
        {
            if (ItemDoubleClick != null)
            {
                ItemDoubleClick(this, new ImageListViewItemDoubleClickEventArgs(item));
            }
        }

        public void OnItemsRemoved(List<ImageListViewItem> items)
        {
            _layoutManager.OnItemsRemoved(items);

            if (ItemsRemoved != null)
            {
                ItemsRemoved(this, new ImageListViewItemsRemovedEventArgs(items));
            }
        }
        ...
        /// 双击项
        /// </summary>
        public event EventHandler<ImageListViewItemDoubleClickEventArgs> ItemDoubleClick;

        /// <summary>
        /// 项被删除
        /// </summary>
        public event EventHandler<ImageListViewItemsRemovedEventArgs> ItemsRemoved;
