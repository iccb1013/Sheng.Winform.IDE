...
namespace WindowsFormsApplication2
{
    ...
    class DataGridViewRenderer
    {
        ...
        private DataGridViewRendererTheme _theme = new DataGridViewRendererTheme();
        ...
        private List<IDataGridViewCellRenderer> _cellRenderers = new List<IDataGridViewCellRenderer>();

        #endregion

        #region 构造

        public DataGridViewRenderer(DataGridView dataGridView)
        {
            AddCellRenderer(new DataGridViewCheckBoxCellRenderer());
        ...
        private void DrawColumnHeader(Graphics g, Rectangle bounds, int columnIndex,string headerText)
        {
            ...
            if (headerCell.SortGlyphDirection != SortOrder.None)
            {
                ...
                GraphicsPath arrowPath = Utility.GetArrowPath(startPoint, endPoint, arrowLength);
        ...
        private IDataGridViewCellRenderer GetCellRenderer(DataGridViewCell cell)
        {
