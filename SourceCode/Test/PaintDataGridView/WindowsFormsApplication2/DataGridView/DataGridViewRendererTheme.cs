...
namespace WindowsFormsApplication2
{
    class DataGridViewRendererTheme
    {
        ...
        private Color _rowUnFocusedSelectedColorEnd = Color.FromArgb(64, SystemColors.GrayText);
        ...
        private Color _rowUnFocusedSelectedBorderColor = Color.FromArgb(128, SystemColors.GrayText);
        /// <summary>
